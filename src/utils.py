...
from src.config import SMALL_GLINER
...
def load_gliner(model_name: str = SMALL_GLINER):
...
# Chargement du dataset sous la forme JSON
...
def load_txt(file_path: Path) -> str:
    """Charge un fichier texte et retourne son contenu sous forme de chaîne de caractères"""
    with file_path.open("r", encoding="utf-8") as fh:
        return fh.read()
